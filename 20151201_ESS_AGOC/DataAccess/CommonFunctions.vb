...
Public Class CommonFunctions
    ...
    Public Function checktable() As String
        ...
        If exists = 0 Then
            ...
            objDA.strQuery += " ,U_CardCode nvarchar(40) NULL,U_Dimension nvarchar(100) NULL,U_JVNo nvarchar(40) NULL,U_CurApprover nvarchar(100) NULL,U_NxtApprover nvarchar(100) NULL)"
            objDA.cmd = New SqlCommand(objDA.strQuery, objDA.con)
            objDA.con.Open()
            objDA.cmd.ExecuteNonQuery()
            objDA.con.Close()
        ...
        If exists = 0 Then
            ...
            objDA.strQuery += " U_CurApprover nvarchar(100) NULL,U_NxtApprover nvarchar(100) NULL,U_Z_AppRequired nvarchar(40) NULL,U_Z_AppReqDate datetime NULL,"
            objDA.strQuery += " U_Z_ReqTime nvarchar(40) NULL,U_Z_ApproveId nvarchar(40) NULL,U_CrEmpName nvarchar(200) NULL,U_CrEmpID nvarchar(100) NULL)"
            objDA.cmd = New SqlCommand(objDA.strQuery, objDA.con)
            objDA.con.Open()
            objDA.cmd.ExecuteNonQuery()
            objDA.con.Close()
