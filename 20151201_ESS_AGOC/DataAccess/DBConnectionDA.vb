...
Public Class DBConnectionDA
    ...
    Public Function Connection() As String
        Try
            ...
            End Select
            Select Case ConfigurationManager.AppSettings("IsCloud")
                Case "No"
    ...
    Public Function readxml()
        ...
        Try
            If File.Exists(System.Web.HttpContext.Current.Server.MapPath("~/App_Data/Login.xml")) Then
                ...
                objen.CPWD = Decrypt(root.SelectSingleNode("CPWD").ChildNodes(0).Value, key) 
    ...
    Public Function DocApproval(ByVal DocType As String, ByVal Empid As String, Optional ByVal LeaveType As String = "") As String
        ...
        End Try
    End Function
    Public Function CheckApprovalExists(ByVal DocType As String, ByVal Empid As String, Optional ByVal LeaveType As String = "") As String
        Try
            Dim strQuery As String = ""
            Dim Status As String = ""
            Dim con As SqlConnection = New SqlConnection(GetConnection)
    ...
    Public Function ViewHistory(ByVal RefCode As String, ByVal DocType As String) As DataSet
        Try
            ...
            sQuery = " Select DocEntry,U_Z_DocEntry,U_Z_DocType,T1.ExtEmpNo AS U_Z_EmpId,U_Z_EmpName,U_Z_ApproveBy,isnull((select T13.firstName +' '+ISNULL(T13.middleName,'') +' '+ isnull(T13.lastName,'')  from OHEM T13 JOIN OUSR T14 ON T14.INTERNAL_K =T13.userId where T14.USER_CODE=T0.U_Z_NextApprover ),'') AS U_Z_NextApprover,"
    ...
    Public Sub SendMail_RequestApproval(ByVal aMessage As String, ByVal Empid As String, ByVal aCompany As SAPbobsCOM.Company, Optional ByVal aMail As String = "")
        ...
        End If
    End Sub
    Public Function GetexpensesOverLap(ByVal StrQuery As String) As DataSet
        Try
            Dim con As SqlConnection = New SqlConnection(GetConnection)
            sqlda = New SqlDataAdapter(StrQuery, con)
            sqlda.Fill(ds)
    ...
    End Sub
    Public Function AlternateRequest(ByVal EmployeeId As String, ByVal DocType As String) As DataSet
        Try
            strQuery = "select T0.""U_Z_EMPID"",T0.""U_Z_EMPNAME"" from ""@Z_HR_LOGIN"" T0 JOIN ""@Z_HR_LOGIN1"" T1 ON T0.""DocEntry""=T1.""DocEntry"" where T1.""U_Z_EMPID""='" & EmployeeId.Trim() & "' and T1.""U_Z_DocType""='" & DocType.Trim() & "'"
            strQuery += "   Union ALL "
            strQuery += " select T0.""U_Z_EMPID"",T0.""U_Z_EMPNAME"" from ""@Z_HR_LOGIN"" T0 where T0.""U_Z_EMPID""='" & EmployeeId.Trim() & "' "
            Dim con As SqlConnection = New SqlConnection(GetConnection)
            sqlda = New SqlDataAdapter(strQuery, con)
            sqlda.Fill(dss5)
            Return dss5
