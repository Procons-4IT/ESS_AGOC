...
Public Class PeopleObjApprovalDA
    ...
    Public Function MainGridbind(ByVal objen As PeopleObjApprovalEN) As DataSet
        Try
            objDA.strQuery1 = "select ""U_DocEntry"",""U_Empid"",""U_PeoobjCode"",""U_PeoobjName"",T1.""U_Z_CatName"",T0.""U_PeoCategory"",CAST(isnull(U_Weight,0) as decimal(10,2)) AS ""U_Weight"",""U_Remarks"",""U_Status"",""U_TypeAction"",""U_RefNo"""
