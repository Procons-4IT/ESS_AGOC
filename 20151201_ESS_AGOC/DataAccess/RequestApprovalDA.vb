...
Public Class RequestApprovalDA
    ...
    Public Function PageloadbindLeaveApproval(ByVal objen As RequestApprovalEN) As DataSet
        Try
            ...
            objDA.strQuery1 = "	select ""U_Z_Status"",T0.""Code"" as ""Code"",""U_Z_EMPID"",""U_Z_EMPNAME"",""U_Z_TrnsCode"",T1.""Name"" as ""Name"",CAST(""U_Z_StartDate"" AS varchar(11)) AS ""U_Z_StartDate"",CAST(""U_Z_EndDate"" AS varchar(11)) AS ""U_Z_EndDate"",cast(T0.U_Z_NoofDays as decimal(10,2)) AS ""U_Z_NoofDays"",""U_Z_AppRemarks"","
            ...
            objDA.strQuery1 += "select case ""U_Z_Status"" when 'A' then 'Approved' when 'P' then 'Pending' when 'R' then 'Rejected' end as ""U_Z_Status"" ,T0.""Code"" as ""Code"",""U_Z_EMPID"",""U_Z_EMPNAME"",""U_Z_TrnsCode"",T1.""Name"" as ""Name"",CAST(""U_Z_StartDate"" AS varchar(11)) AS ""U_Z_StartDate"",CAST(""U_Z_EndDate"" AS varchar(11)) AS ""U_Z_EndDate"",cast(T0.U_Z_NoofDays as decimal(10,2)) AS ""U_Z_NoofDays"",""U_Z_AppRemarks"","
