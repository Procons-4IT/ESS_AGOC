...
Public Class SelfAppraisalDA
    ...
    Public Sub UpdateSelfAppBusiness(ByVal objen As SelfAppraisalEN)
        Try
            objen.StrQry = "Update [@Z_HR_SEAPP1] set U_Z_SelfRaCode='" & objen.SelfRating & "', U_Z_BussSelfRate=" & objen.Amount & ",U_Z_SelfRemark='" & objen.BusinessRemarks & "' where DocEntry='" & objen.AppraisalNumber & "' and LineId=" & objen.LineNo & ""
            objDA.cmd = New SqlCommand(objen.StrQry, objDA.con)
            objDA.con.Open()
            objDA.cmd.ExecuteNonQuery()
            objDA.con.Close()
    ...
    Public Sub UpdateSelfAppPeople(ByVal objen As SelfAppraisalEN)
        Try
            objen.StrQry = "Update [@Z_HR_SEAPP2] set U_Z_SelfRaCode='" & objen.SelfRating & "',U_Z_PeoSelfRate=" & objen.Amount & ",U_Z_SelfRemark='" & objen.PeopleRemarks & "' where DocEntry='" & objen.AppraisalNumber & "' and LineId=" & objen.LineNo & ""
            objDA.cmd = New SqlCommand(objen.StrQry, objDA.con)
            objDA.con.Open()
            objDA.cmd.ExecuteNonQuery()
            objDA.con.Close()
    ...
    Public Sub UpdateSelfAppCompetence(ByVal objen As SelfAppraisalEN)
        Try
            objen.StrQry = "Update [@Z_HR_SEAPP3] set U_Z_SelfRaCode='" & objen.SelfRating & "',U_Z_CompSelfRate=" & objen.Amount & ",U_Z_SelfRemark='" & objen.CompRemarks & "' where DocEntry='" & objen.AppraisalNumber & "' and LineId=" & objen.LineNo & ""
            objDA.cmd = New SqlCommand(objen.StrQry, objDA.con)
            objDA.con.Open()
            objDA.cmd.ExecuteNonQuery()
            objDA.con.Close()
