                                                                        ...
                                                                        <td>
                                                                            <asp:GridView ID="grdLoanRequest" runat="server" CellPadding="4" AllowPaging="True"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Loan Distribution Date" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblDisdate" runat="server" Text='<%#Bind("U_DisDate") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Loan Start Date" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblstdate" runat="server" Text='<%#Bind("U_InstDate") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="No of Installment" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                    ...
                                    <asp:Panel ID="PanelNewRequest" runat="server" Width="100%" BorderColor="LightSteelBlue"
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajx:ModalPopupExtender ID="ModalPopupExtender3" runat="server" DropShadow="True"
                                                        PopupControlID="AltPanel" TargetControlID="btnfindEmp" CancelControlID="Button2"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtloanAmt" CssClass="txtbox" runat="server" Visible="false" onkeypress="AllowNumbers(this);checkDec(this);RemoveZero(this);"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtLodisDate" CssClass="txtbox" runat="server" Visible="false"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtLoStdate" CssClass="txtbox" runat="server" Visible="false"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtnoEMI" CssClass="txtbox" Visible="false" runat="server" onkeypress="AllowNumbers(this);checkDec(this);RemoveZero(this);"
                                                        onkeyup="AllowNumbers(this);checkDec(this);RemoveZero(this);"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
