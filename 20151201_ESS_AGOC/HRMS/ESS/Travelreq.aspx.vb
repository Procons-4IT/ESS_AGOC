...
Public Class Travelreq
    ...
    Private Function Validation() As Boolean
        ...
        Try
            ...
            ' dbcon.strQuery = " select * from [@Z_HR_OTRAREQ] where U_Z_EmpId='" & txtempid.Text.Trim() & "' and  U_Z_TraStDate >= '" & dtFrom.ToString("yyyy-MM-dd") & "' and U_Z_TraEndDate <= '" & dtTo.ToString("yyyy-MM-dd") & "' "
            oRec.DoQuery(dbcon.strQuery)
            If oRec.RecordCount > 0 Then
                'dbcon.strmsg = "A travel request is already approved for the selected date, do you want to continue?"
