...
Public Class LeaveRequest
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            ElseIf Session("SAPCompany") Is Nothing Then
                ...
                End If
            End If
            ExpintTempID = dbCon.CheckApprovalExists("LveReq", Session("UserCode").ToString())
    ...
    Protected Sub btnnew_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnnew.Click
        ...
        dbCon.dss5 = dbCon.AlternateRequest(Session("UserCode").ToString(), "LveReq")
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Else
            ...
            ElseIf objEN.EndDate = "" Then
                ...
                '    mess(dbCon.strmsg)
            ElseIf CDbl(objEN.NoofDays) <= 0 Then
