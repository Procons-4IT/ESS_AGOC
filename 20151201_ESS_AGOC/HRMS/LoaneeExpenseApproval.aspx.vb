...
Public Class LoaneeExpenseApproval
    ...
    Private Sub grdRequestApproval_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdRequestApproval.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim ddlAppStatus As DropDownList = DirectCast(e.Row.FindControl("ddlAppStatus"), DropDownList)
            objEN.SapCompany = Session("SAPCompany")
            ...
            If ddlAppStatus.SelectedValue <> "R" Then
        ...
        If e.Row.RowType = DataControlRowType.Footer Then
            ...
            lbl2.Text = ViewState("LocalCurrency") & Math.Round(grdTotal2, 2)
        End If
    End Sub
            ...
            Else
                ...
                If Validation() = True Then
                    For Each row1 In grdRequestApproval.Rows
                        ...
                        objEN.HistoryType = "Loanee"
                        objEN.HeaderType = "Loanee"
                    ...
                    If dbCon.strmsg = "Success" Or dbCon.strmsg = "Successfully approved document..." Then
                        ...
                        If blnflag = True Then
                            If strMailDocEntry <> "" Then
                                StrMailMessage = "Expenses Claim request is :" & lbldocno.Text.Trim() & " with Expenses :" & strMailDocEntry & " are approved. "
                                StrMailMessage = "Expenses Claim request approved for the request code : " & CInt(strMailDocEntry) & " in the expense claim number: " & CInt(lbldocno.Text.Trim())
                                objDBL.SendMail_RequestApproval(StrMailMessage, objEN.EmpId, objEN.SapCompany)
                            End If
                        End If
    ...
    Private Sub grdSummary_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdSummary.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim ddlAppStatus As Label = DirectCast(e.Row.FindControl("lblsAppStatus"), Label)
            objEN.Remarks = e.Row.DataItem("U_Z_Attachment")
            If objEN.Remarks = "" Then
                Liremove.Visible = False
            Else
                Liremove.Visible = True
            End If
            If ddlAppStatus.Text <> "Rejected" Then
                Dim rowtotal As Decimal = Convert.ToDecimal(lblTransAmt.Text.Trim())
