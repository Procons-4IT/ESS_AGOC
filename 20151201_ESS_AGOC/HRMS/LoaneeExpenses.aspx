<%@ Page Title="Loanee Expenses" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master" CodeBehind="LoaneeExpenses.aspx.vb" Inherits="HRMS.LoaneeExpenses" %>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                ...
                <tr>
                    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"
                        ...
                        <div>
                            &nbsp;
                            <asp:Label ID="Label3" runat="server" Text="Loanee Expenses Claim Request" CssClass="subheader"
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <ajx:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0" CssClass="ajax__tab_yuitabview-theme"
                                                        Width="100%">
                                                        <ajx:TabPanel ID="TabPanel3" runat="server" HeaderText="Loanee Expenses Claim Request">
                                                            <ContentTemplate>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">
                                                        <asp:Label ID="lblempNo" CssClass="txtbox" runat="server"></asp:Label>
                                                           <asp:ImageButton ID="btnfindEmp" runat="server" Text="Find" ImageUrl="~/images/search.jpg" ToolTip="Search" />
                                                    <ajx:ModalPopupExtender ID="ModalPopupExtender4" runat="server" DropShadow="True"
                                                        PopupControlID="Panel6" TargetControlID="btnfindEmp" CancelControlID="Button2"
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <ajx:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="ajax__tab_yuitabview-theme"
                                                            Width="100%">
                                                            <ajx:TabPanel ID="TabPanel5" runat="server" HeaderText="Loanee Expenses Claim Request">
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:GridView ID="grdRequestExpenses" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor"
                                                                                    ...
                                                                                    AutoPostback="flash"  AlternatingRowStyle-CssClass="alt"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblreqby" runat="server" Text='<%#Bind("U_CrEmpName") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    </Columns>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:GridView ID="grdApproved" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor"
                                                                                      CssClass="mGrid" HeaderStyle-CssClass="GridBG"
                                                                                    ShowFooter="true" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                                                    AutoGenerateColumns="false" Width="100%" ShowHeaderWhenEmpty="true" EmptyDataText="No records Found">
                                                                                    <Columns>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblAreqby" runat="server" Text='<%#Bind("U_Z_CrEmpName") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                            ...
                                                                            <td>
                                                                                <asp:GridView ID="grdRejected" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblRreqby" runat="server" Text='<%#Bind("U_Z_CrEmpName") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Approval History">
                                                                                            <ItemTemplate>
                ...
                <tr>
                    <td>
                        <asp:Panel ID="PanelItemEntry" runat="server" BackColor="White" Style="display: none;
                            ...
                            <div>
                                <span class="sideheading" style="color: Green;">Loanee Expenses Claim Request</span> <span
                                    style="float: right;">
                                ...
                                <asp:Panel ID="Panel1" runat="server" Width="100%">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txttrasdt" CssClass="txtbox" runat="server" AutoPostBack="true"></asp:TextBox>
                                            ...
                                            <td>
                                            <asp:TextBox ID="txttratodt" CssClass="txtbox" runat="server"></asp:TextBox>
                                                <ajx:CalendarExtender ID="CalendarExtender1" Animated="true" Format="dd/MM/yyyy"
                                                    runat="server" TargetControlID="txttratodt" CssClass="cal_Theme1">
                                                </ajx:CalendarExtender>
                                                <asp:TextBox ID="txtcity" CssClass="txtbox" runat="server" Visible="false"></asp:TextBox>
                ...
                <tr>
                  ...
                  <tr>
                    <td>
                        <asp:Panel ID="Panel6" runat="server" BackColor="White" Style="display: none; padding: 10px;
                            width: 500px;">
                            <div>
                                <span class="sideheading" style="color: Green;">Alternate Employee Request</span>
                                <span style="float: right;">
                                    <asp:Button ID="Button2" runat="server" CssClass="btn" Width="30px" Text="X" /></span></div>
                            <br />
                            <asp:Panel ID="Panel8" runat="server" Height="200px" ScrollBars="Vertical">
