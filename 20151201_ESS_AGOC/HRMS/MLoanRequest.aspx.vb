    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            ElseIf Session("SAPCompany") Is Nothing Then
                ...
                End If
            End If
            ExpintTempID = dbCon.CheckApprovalExists("LoanReq", Session("UserCode").ToString())
    ...
    Private Sub btnnew_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnnew.Click
        Try
            ...
            Else
                ...
                txtnoEMI.Text = ""
                btnAdd.Visible = True
                txtempid.Text = Session("UserCode").ToString()
                txtempname.Text = Session("UserName").ToString()
                dbCon.dss5 = dbCon.AlternateRequest(Session("UserCode").ToString(), "LoanReq")
    ...
    Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            ...
            Else
                ...
                objEN.Empid = txtempid.Text.Trim() 'Session("UserCode").ToString()
                objEN.EmpName = txtempname.Text.Trim() 'Session("UserName").ToString()
                objEN.LoanType = txtlvecode.Text.Trim()
                objEN.LoanName = txtloanName.Text.Trim()
                objEN.NoEMI = 0 'txtnoEMI.Text.Trim()
                objEN.StrCode = txtcode.Text.Trim()
                objEN.AltEmpid = Session("UserCode").ToString()
                objEN.AltEmpName = Session("UserName").ToString()
                ...
                If BlnFlag = True Then
                    intTempID = dbCon.GetTemplateID("LoanReq", txtempid.Text.Trim())
                    If intTempID <> "0" Then
                        dbCon.UpdateApprovalRequired("U_LOANREQ", "U_DocEntry", objEN.StrCode, "Y", intTempID)
                        dbCon.InitialMessage("Loan Request", objEN.StrCode, dbCon.DocApproval("LoanReq", txtempid.Text.Trim()), intTempID, objEN.EmpName, "LoanReq", objEN.SapCompany)
                    Else
