                      ...
                      <table width="99%" border="0" cellspacing="0" cellpadding="3" class="main_content">                                   
                            ...
                            <asp:TemplateField HeaderText="Thursday">
                                 ...
                                 <asp:TemplateField HeaderText="Training Location">
                                    <ItemTemplate>
                                        <div align="left">&nbsp;<asp:Label ID="lbltrainloc" runat="server" Text='<%# Eval("U_Z_TrainLoc") %>' ></asp:Label></div>
                                    </ItemTemplate>                                    
                                </asp:TemplateField>  
                                 <asp:TemplateField HeaderText="Travel Expenses">
                                    <ItemTemplate>
                                        <div align="left">&nbsp;<asp:Label ID="lblEstExp" runat="server" Text='<%# Eval("U_Z_EstExpe") %>' ></asp:Label></div>
                                    </ItemTemplate>                                    
                                </asp:TemplateField>                                                        
                            </Columns>
