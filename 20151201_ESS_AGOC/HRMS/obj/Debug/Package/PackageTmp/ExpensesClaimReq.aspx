                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:GridView ID="grdRequestExpenses" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor"
                                                                                    CssClass="mGrid" HeaderStyle-CssClass="GridBG" PagerStyle-CssClass="pgr" AutoPostback="flash" AllowPaging="true" PageSize="15"
                                                                                    AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false" Width="100%" ShowHeaderWhenEmpty="true"
                                                            ...
                                                            <ajx:TabPanel ID="TabPanel1" runat="server" HeaderText="Approved Expenses Claim">
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:GridView ID="grdApproved" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor" AllowPaging="true" PageSize="15"
                                                            ...
                                                            <ajx:TabPanel ID="TabPanel2" runat="server" HeaderText="Rejected Expenses Claim">
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:GridView ID="grdRejected" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor" AllowPaging="true" PageSize="15"
                                                                                    CssClass="mGrid" HeaderStyle-CssClass="GridBG" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                                                    AutoGenerateColumns="false" Width="100%" ShowHeaderWhenEmpty="true" EmptyDataText="No records Found">
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="Request Code">
