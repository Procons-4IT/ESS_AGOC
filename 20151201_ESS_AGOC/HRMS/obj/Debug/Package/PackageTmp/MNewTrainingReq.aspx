                                ...
                                <tr>
                                 <td >Request Code</td>
                                    ...
                                    <td >Training Course Cost</td>
                                     <td>                                     
                                       <asp:TextBox ID="txtcost" CssClass="txtbox" runat="server"  onkeypress="AllowNumbers(this);checkDec1(this);RemoveZero(this);" onkeyup="AllowNumbers(this);checkDec1(this);RemoveZero(this);"></asp:TextBox>                                                
                                     </td>  
                                       <td>Est.Travel and Living Expenses</td>
                                     <td>
                                     <asp:TextBox ID="txtestexp" CssClass="txtbox"  runat="server" onkeypress="AllowNumbers(this);checkDec1(this);RemoveZero(this);" onkeyup="AllowNumbers(this);checkDec1(this);RemoveZero(this);"></asp:TextBox>                                           
                                     </td>
                                     </tr>                                    
                                      <tr>
                                     ...
                                     <td>
                                      <asp:TextBox ID="txtBussDur" CssClass="txtbox"  runat="server" onkeypress="AllowNumbers(this);checkDec(this);RemoveZero(this);" onkeyup="AllowNumbers(this);checkDec(this);RemoveZero(this);"></asp:TextBox>  
                                     </td>
                                     <td >Training Duration (Calendar Days)</td>
                                     <td>
                                      <asp:TextBox ID="txtCalDur" CssClass="txtbox"  runat="server" onkeypress="AllowNumbers(this);checkDec(this);RemoveZero(this);" onkeyup="AllowNumbers(this);checkDec(this);RemoveZero(this);"></asp:TextBox>  
                                     </td>
                                      </tr>
                                      <tr>
                                      <td >Away from Office(Business Days)</td>
                                     <td>
                                      <asp:TextBox ID="txtawaybuss" CssClass="txtbox"  runat="server" onkeypress="AllowNumbers(this);checkDec(this);RemoveZero(this);" onkeyup="AllowNumbers(this);checkDec(this);RemoveZero(this);"></asp:TextBox>                                             
                                     </td>
